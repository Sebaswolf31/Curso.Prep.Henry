...
function pasarUsuarioAPremium(usuarios) {
  ...
  // Tu código:
  // elemento map ejecuta una acciom por cada elemento del array
...
function sumarLikesDeUsuario(usuario) {
  ...
  usuario.posts.map (function(element) {
    cantidadSuma += element.likes; // esto es lo mismo que hacer de la sigueinte manera cantidadSuma = cantidadSuma + element.likes;
  });
  return cantidadSuma;
}
